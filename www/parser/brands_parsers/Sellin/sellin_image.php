...
if (isset($arrayDopImage)) {
    ...
    foreach ($arrayDopImage as $value) {
        $srcDopIm = filterUrlImage(str_replace("product_pictures",
                "products_pictures", $value['src']), $curLink);
        $srcDopIm = str_replace(".JPG", ".jpg", $srcDopIm);
        $wovels   = array("_enl.jpg", "_thm.jpg", "_th.jpg");
        $srcDopIm = str_replace($wovels, ".jpg", $srcDopIm);
