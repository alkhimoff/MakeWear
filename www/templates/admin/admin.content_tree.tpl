...
{$all_lines}
  <!--
<DIV class=node id="node_1"><table border=0 cellspacing=0 cellpadding=0><tr><td><a onClick='changeNode(1);'><img name=conerimage_1 src=templates/{$theme_name}/images/nav_cconer.gif width=20 height=20 border=0></a></td><td colspan=99 style='padding-top:5px!important;'><nobr><img name=folderimage_1 src=templates/{$theme_name}/images/nav_cfolder.gif width=20 height=20  align="absmiddle" border=0 ><a href=#1 onClick="openFolder(1);" ><span id="nname_1" onDblClick='changeNode(1);' >&nbsp;Головна сторінка [top]&nbsp;</span></a></nobr></td></tr></table></DIV> 
<DIV class=node id="node_2"><table border=0 cellspacing=0 cellpadding=0><tr><td><img src=templates/{$theme_name}/images/nav_line.gif width=20 height=20 border=0 align='absmiddle' alt=''></td><td><a onClick='changeNode(2);'><img name=conerimage_2 src=templates/{$theme_name}/images/nav_cconer.gif width=20 height=20 border=0></a></td><td colspan=99><nobr><img name=folderimage_2 src=templates/{$theme_name}/images/nav_cfolder.gif width=20 height=20  align="absmiddle" border=0><a href=#2 onClick="openFolder(2);"><span id="nname_2" onDblClick='changeNode(2);'>&nbsp;Підприємство&nbsp;</span></a></nobr></td></tr></table></DIV> 
