...
<tr height="200">
    <td width="100%">
        ...
        <p style="font-family:CenturyGothic;font-size:16px;margin:30px 0 10px 10px;">Новый заказ!</p>
    ...
    <td>
        <table width="400px" cellpadding="0" cellspacing="0" border="1" style="border-color:#000;border-collapse:collapse;margin:5px 0;padding:5px;">
            <tbody>
                ...
                <tr>
                    <td>
                        <p style="margin:3px 5px"><font face="CenturyGothic" color="#000" style="font-size:14px;"><b>Ip-адрес</b></font></p>
                    </td>
                    <td>
                        <p style="margin:3px 5px"><font face="CenturyGothic" color="#000" style="font-size:14px;">{$userIp}</font></p>
                    </td>
                </tr>
            </tbody>
        </table>
