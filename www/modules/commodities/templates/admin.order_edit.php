...
<tr><td></td><th>Бренд</th><th>Артикул</th><th>Цвет</th><th>Размер</th><th>Кол-во</th><th>Валюта</th><th>Цена{$order_select}</th><th>Сумма</th><th>Ссылка на товар</th><th>Источник</th><th>Комментарий</th><th>Статус</th></tr>
...
<td style='width:500px;'>
	<table class='cl_big_table cl_need_reload'>
		...
		<tr><td><a href='?admin=mail_to_customer&id={$id}'>Отправить письмо</a></td></tr>
		<tr  id='{$row["id"]}' rel='shop_orders'  rel2='id'>
			<th>
				Доставка
			</th>
...
<td>
	<table class='cl_big_table'>
		...
		<tr><th>Кол-во</th><td>{$total_count}</td></tr>
		<tr >
			<th>
				<h2>Всего к оплате:</h2>
			</th>
			<td >
				<h2>{$total_price1} {$cur}</h2>
			</td>
...
<tr>
		...
		<tr>
			<td><form action='/?admin=add_order_com' method='post'>
				<table class = 'add_commodity_to_order'>
				<tr>
				<tr><th colspan = '2'>Добавить товар</th></tr>
 					...
 					<tr><td></td><td><input type='submit' value = 'Добавить товар'></td></tr>
				</table></form></td>
		</tr>
</table>
</td>
